...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/asr/ruletypes.cc,v 4.7.8.2 1998/10/08 11:26:21 jaharkes Exp $";
#endif /*_BLURB_*/
...
int command_t::execute() {
    ...
    for (i = 0, index = 1; i < argc; i++, index++) 
