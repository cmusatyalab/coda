 ...
 */
void ParseRemoteLogs(char *buf, int bufsize, int nentries, olist **hlist,
                     rsle **RemoteLogEntries)
{
...
static void ReadOpsFromBuf(char *buf, int bufsize, int nentries,
                           rsle **RemoteLogEntries)
{
...
olist *FindRemoteLog(olist *AllLogs, unsigned long hostid, ViceFid *Fid)
{
