...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/RCSLINK/./coda-src/rvmres/subresphase34.cc,v 1.1 1996/11/22 19:13:32 braam Exp $";
#endif /*_BLURB_*/
