...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/resolve/Attic/repio.cc,v 4.3 1997/12/23 17:19:54 braam Exp $";
#endif /*_BLURB_*/
...
#define ADVANCE()\
    ...
    bzero(rs, sizeof(struct repair));  /* init all fields to 0 */
