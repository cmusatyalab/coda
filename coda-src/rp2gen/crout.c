...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/rp2gen/Attic/crout.c,v 4.13.2.1 1998/10/08 11:26:41 jaharkes Exp $";
#endif /*_BLURB_*/
...
#define PUTPARMS()\
	...
	fprintf(where, "long %s_ExecuteRequest(", subsystem.subsystem_name);
	if (strictproto)
