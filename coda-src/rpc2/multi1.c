...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/rpc2/Attic/multi1.c,v 4.4.6.1 1998/12/10 16:38:32 jaharkes Exp $";
#endif /*_BLURB_*/
    ...
    struct timeval *BreathOfLife;
{
    ...
    bzero(slarray, sizeof(char *) * (HowMany + 2));
    bzero(req, sizeof(char *) * HowMany);
...
PRIVATE void SetupPackets(HowMany, ConnHandleList, ceaddr, slarray, MCast,
	...
	rpc2_InitPacket(thisreq, NULL, Request->Header.BodyLength);
        bcopy(Request->Body, thisreq->Body, Request->Header.BodyLength);
