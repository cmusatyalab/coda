...
#*/
#
#static char *rcsid = "$Header: /afs/cs/project/coda-src/cvs/coda/coda-src/scripts/reinit.sh,v 4.3 1998/01/20 20:53:16 braam Exp $";
#endif /*_BLURB_*/
...
# Make sure we are on a Coda server.
if ( ! -e /vice/db/scm || ! -e /vice/hostname ) then
