...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/venus/Attic/advice.cc,v 4.10 1998/11/24 15:34:48 jaharkes Exp $";
#endif /*_BLURB_*/
...
#if  0  /* XXXX what's going on herer */
