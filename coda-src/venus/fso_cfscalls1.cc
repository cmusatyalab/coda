...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/coda-src/venus/RCS/fso_cfscalls1.cc,v 1.1 1996/11/22 19:10:59 braam Exp $";
#endif /*_BLURB_*/
...
void fsobj::LocalMkdir(Date_t Mtime, fsobj *target_fso, char *name,
	...
	bcopy(SpecificUser, target_fso->SpecificUser, (int)(CPSIZE * sizeof(AcRights)));
