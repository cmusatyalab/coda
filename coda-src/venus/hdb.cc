...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/coda-src/venus/RCS/hdb.cc,v 1.2 1996/11/24 21:00:30 braam Exp braam $";
#endif /*_BLURB_*/
...
PRIVATE int AuthorizedUser(vuid_t);
