...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/coda-src/venus/RCS/vol_resolve.cc,v 1.1 1996/11/22 19:11:29 braam Exp $";
#endif /*_BLURB_*/
...
void volent::Resolve() {
...

	{
	    ...
	    code = (int)ViceResolve(c->connid, &r->fid);
