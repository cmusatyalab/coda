...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/coda-src/vol/RCS/vsg.cc,v 1.1 1996/11/22 19:10:39 braam Exp $";
#endif /*_BLURB_*/
...
unsigned long GetVSGAddress(unsigned long *hosts, int nh) {
	...
	if (!bcmp(CanHosts, v->Hosts, sizeof(long) * VSG_MEMBERS) &&
	    nh == v->nhosts)
	    return(v->VSGaddr);
    }
