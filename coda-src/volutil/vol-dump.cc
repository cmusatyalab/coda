...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/volutil/vol-dump.cc,v 4.3 1997/02/26 16:04:07 rvb Exp $";
#endif /*_BLURB_*/
...
#define RCSVERSION $Revision: 4.3 $
