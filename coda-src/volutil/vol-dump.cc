...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/coda-src/volutil/vol-dump.cc,v 4.4 1997/10/23 19:26:06 braam Exp $";
#endif /*_BLURB_*/
...
#define RCSVERSION $Revision: 4.4 $
