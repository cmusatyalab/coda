...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/RCSLINK/./coda-src/volutil/vol-printstats.cc,v 1.1 1996/11/22 19:14:18 braam Exp $";
#endif /*_BLURB_*/
