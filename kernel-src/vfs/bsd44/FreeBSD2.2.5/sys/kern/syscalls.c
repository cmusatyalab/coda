...
char *syscallnames[] = {
	...
	"shmdt",			/* 230 = shmdt */
	"shmget",			/* 231 = shmget */
	"#232",			/* 232 = clock_gettime */
	"#233",			/* 233 = clock_settime */
	"#234",			/* 234 = clock_getres */
	...
	"#350",			/* 350 = nosys */
#ifdef CFS
	"sys_icreate",			/* 351 = sys_icreate */
	"sys_iopen",			/* 352 = sys_iopen */
	"sys_iread",			/* 353 = sys_iread */
	"sys_iwrite",			/* 354 = sys_iwrite */
	"sys_iinc",			/* 355 = sys_iinc */
	"sys_idec",			/* 356 = sys_idec */
	"sys_pioctl",			/* 357 = sys_pioctl */
	"#358",			/* 358 = setpag */
	"#359",			/* 359 = nosys */
	"#360",			/* 360 = nosys */
#else /* !CFS */
