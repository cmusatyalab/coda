...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/RCSLINK/./kernel-src/vfs/mach/mach_vioctl.h,v 1.1 1996/11/22 19:16:21 braam Exp $";
#endif /*_BLURB_*/
