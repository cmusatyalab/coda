...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/RCSLINK/./lib-src/libcs/del.c,v 1.1 1996/11/22 19:19:48 braam Exp $";
#endif /*_BLURB_*/
