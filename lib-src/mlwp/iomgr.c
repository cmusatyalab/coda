...
static char *rcsid = "$Header: /afs/cs/project/coda-src/cvs/coda/lib-src/mlwp/iomgr.c,v 4.11 98/06/16 21:01:48 braam Exp $";
#endif /*_BLURB_*/
...
#define STACK_SIZE	0x10000  /* 64K hopefully more than enough */
