...
static char *rcsid = "$Header: /coda/coda.cs.cmu.edu/project/coda/cvs/coda/lib-src/mlwp/Attic/lwp.c,v 4.7.2.1 1998/05/02 21:41:38 braam Exp $";
#endif /*_BLURB_*/
...
PRIVATE void Dump_One_Process (PROCESS pid, FILE *fp, int dofree);
