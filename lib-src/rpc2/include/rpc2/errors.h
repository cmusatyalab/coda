...
#ifndef ETOOMANYREFS
#define ETOOMANYREFS                                                           \
    (RPC2_ERRBASE + 59) /* Too many references: can't splice  \
                                            */
#endif
#ifndef ETIMEDOUT
...
#define EINCOMPATIBLE                                                          \
    (RPC2_ERRBASE + 198) /* Version vectors are incompatible */
#endif
#ifndef EINCONS
...
// #define CAEFAIL        300 /* Unknown error related to the
//                               Advice Monitor */
// #define CAEVERSIONSKEW 301 /* Version skew between Venus and the
//                               Advice Monitor */
#ifndef CAENOSUCHUSER
/* Advice Monitor attempted to connect on behalf of an unknown user */
#define CAENOSUCHUSER (RPC2_ERRBASE + 302)
#endif
#ifndef CAENOTVALID
/* Advice Monitor attempted to test liveness of an invalid connection */
#define CAENOTVALID (RPC2_ERRBASE + 303)
#endif
#ifndef CAENOASR
/* Advice Monitor returned the result of an ASR, but not ASR is pending */
#define CAENOASR (RPC2_ERRBASE + 304)
#endif
#ifndef CAEUNEXPECTEDASR
/* Advice Monitor returned the result of the wrong ASR */
#define CAEUNEXPECTEDASR (RPC2_ERRBASE + 305)
#endif
// #define CAEASRINPROGRESS 306 /* Venus requested an ASR while another
//                                 one is in progress */
#ifndef CAEADVICEPENDING
/* Advice Monitor requested a new connection while a request is pending */
#define CAEADVICEPENDING (RPC2_ERRBASE + 307)
#endif
#ifndef CAENOSERVERS
