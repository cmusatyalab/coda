...
#define RPC2_NEWCONNECTION \
    -13 /* opcode of fake request generated by RPC2_GetRequest() on new connection */
...
System Limits
*/
#define RPC2_MAXPACKETSIZE \
    4500 /* size of the largest acceptable packet buffer in bytes (includes prefix and header) */
...
*/
typedef int32_t
    RPC2_Integer; /*32-bit,  2's  complement representation.  On other machines, an explicit
