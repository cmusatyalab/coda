...
#define BLOCK_END(bp) \
    ((guard_t *)((char *)(bp) + ((bp)->size * RDS_CHUNK_SIZE)) - 1)

#define USER_BLOCK(bp) ((char *)&((bp)->prev))
#define BLOCK_HDR(bp) \
    ((free_block_t *)((char *)(bp) - (sizeof(block_size_t) + sizeof(guard_t))))
...
#define NEXT_CONSECUTIVE_BLOCK(bp) \
    ((free_block_t *)((char *)(bp) + ((bp)->size * RDS_CHUNK_SIZE)))
