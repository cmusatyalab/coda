...
static char *rcsid = "$Header: /afs/cs.cmu.edu/project/coda-braam/src/coda-4.0.1/RCSLINK/./rvm-src/seg/rvm_segment_private.h,v 1.1 1996/11/22 19:17:16 braam Exp $";
#endif _BLURB_
